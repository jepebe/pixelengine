...
def update(window: pxng.Window):
    ...
    window.draw_string(10, 10, 'Text Rendering', tint=LIGHT_BLUE)
    ...
    for row in range(row_count):
        ...
        window.draw_string(15, 25 + row * 6, row_txt, scale=0.5, tint=LIGHT_GREEN)

    text = 'Text Rotated 90 degrees'
    window.draw_string(240, 25, text, scale=0.5, tint=LIGHT_ORANGE, angle=90)

    text = f'Frames rendered: {frame}'
    window.draw_string(10, 230, text, tint=LIGHT_YELLOW, scale=0.5)
